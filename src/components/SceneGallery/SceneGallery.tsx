...
const SceneGallery: React.FC<SceneGalleryProps> = ({ sceneImages, handleImageClick, mediaType }) => {
  return (
    <div>
      <h2 className="text-2xl text-yellow-500 font-bold ml-16 my-8">{mediaType == "movie" ? "Movie Scenes" : "TV Show Scenes"}</h2>
